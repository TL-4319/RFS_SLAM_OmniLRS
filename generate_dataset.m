...
dataset.sensor_time_vec = [dataset.time_vec(dataset.lidar_avail == 1),timing_data(dataset.lidar_avail == 1,1)];
...
for ii = 1:size(ENU_tf_world_base,3)
    ...
    if draw == 1
            ...
            draw_trajectory_se3(NED_tf_world_base(:,:,ii), NED_tf_world_base(:,:,1:ii), 1, 2, 'k', 0)
...
save(strcat(path_to_folder,"preproc.mat"),"dataset")
